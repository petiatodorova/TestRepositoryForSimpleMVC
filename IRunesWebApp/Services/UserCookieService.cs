namespace IRunesWebApp.Services
{
    ...
    {
        private const string EncriptKey = "E546C8DF278CD5931069B522E695D4F2";

        public string GetUserCookie(string username)
        {
            var cookieContent = EncryptString(username, EncriptKey);
        ...
        {
            var username = DecryptString(cookieContent, EncriptKey);
